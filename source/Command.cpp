...
const Command Command::SPLITSCREEN(ONE << 26, "Toggle Splitscreen");
...
const Command Command::SFORWARD(ONE << 37, "2 Forward thrust");
const Command Command::SLEFT(ONE << 38, "2 Turn left");
const Command Command::SRIGHT(ONE << 39, "2 Turn right");
const Command Command::SBACK(ONE << 40, "2 Reverse");
const Command Command::SPRIMARY(ONE << 41, "2 Fire primary weapon");
const Command Command::SSECONDARY(ONE << 42, "2 Fire secondary weapon");
const Command Command::SSELECT(ONE << 43, "2 Select secondary weapon");
