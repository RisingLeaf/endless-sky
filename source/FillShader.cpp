...
void FillShader::Init()
{
	...
	static const char *fragmentCode =
		...
		"  {\n"
		"    vec2 pointOnLine;\n"
  		"    vec2 startToEnd = gradientEnd - gradientStart;\n"
		"    float startToEndSquared = dot(startToEnd, startToEnd);\n"
		"    if(startToEndSquared == 0)\n"
		"      pointOnLine = gradientStart;\n"
		"    else\n"
		"    {\n"
		"      vec2 startToPoint = gl_FragCoord.xy - gradientStart;\n"
		"      float t = dot(startToPoint, startToEnd) / startToEndSquared;\n"
    	"      if (t < 0.0)\n"
		"        pointOnLine = gradientStart;\n"
		"      else if (t > 1.0)\n"
		"        pointOnLine = gradientEnd;\n"
		"      else\n"
		"        pointOnLine = gradientStart + t * startToEnd;\n"
		"    }\n"
		"    float mixFactor = length(gradientStart - pointOnLine) / length(gradientStart - gradientEnd);\n"
		"    finalColor = color * mixFactor + colorB *(1. - mixFactor);\n"
		"  }\n"
		"  else\n"
		"    finalColor = color;\n"
		"}\n";
