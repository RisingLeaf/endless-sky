...
void VulkanSwapChain::CreateSwapChain()
{
	...
	{
		Logger::LogError(std::to_string(result));
...
{
	// Comment out these lines for mobile devices, as mailbox has high power consumption.
	// Talking about ES-mobile here.
	for(const auto &availablePresentMode : availablePresentModes)
		if(availablePresentMode == VK_PRESENT_MODE_MAILBOX_KHR)
		{
			Logger::LogError("Present mode: Mailbox");
			return availablePresentMode;
		}

	Logger::LogError("Present mode: V-Sync");
